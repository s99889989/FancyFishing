...
public class OrbitalActionStop extends BukkitRunnable {
    ...
    public OrbitalActionStop(String uuidString, GuiseEntity guiseEntity, Location sourceLocation, Location targetLocation){
